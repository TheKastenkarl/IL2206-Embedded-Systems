...
procedure mixedscheduling is
   ...
   begin
    ...
    -- Tasks with FIFO_Within_Priority scheduling (task set 1, high priority)
    ...
    -- Tasks with Round_Robin_Within_Priorities scheduling (background tasks, low priority)
    Task_4 : T(4, 1, Warm_Up_Time, 20, 100, 10000); -- ID: 4
	                                                  -- Priority: 1
                                                      -- Phase: Warm_Up_Time (100)
	                                                  -- Period 20, 
	                                                  -- Computation Time: 100 (if correctly calibrated) 
	                                                  -- Relative Deadline: 10000

    Task_5 : T(5, 1, Warm_Up_Time, 20, 100, 10000); -- ID: 5
	                                                  -- Priority: 1
                                                      -- Phase: Warm_Up_Time (100)
	                                                  -- Period 20, 
	                                                  -- Computation Time: 100 (if correctly calibrated) 
    ...
    Task_6 : T(6, 1, Warm_Up_Time, 20, 100, 10000); -- ID: 6
	                                                  -- Priority: 1
                                                      -- Phase: Warm_Up_Time (100)
	                                                  -- Period 20, 
	                                                  -- Computation Time: 100 (if correctly calibrated) 
